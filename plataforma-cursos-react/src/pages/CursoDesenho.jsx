    ...
    <>
      ...
      <main className="curso-detalhes-page">
        <div className="container">
          <h1 className="curso-titulo">Artes e Criatividade: Desenho e Pintura</h1>
          <p className="curso-descricao">
            Desenvolva sua expressão artística com técnicas básicas de desenho e pintura. Ideal para crianças e iniciantes no mundo das artes.
          </p>
