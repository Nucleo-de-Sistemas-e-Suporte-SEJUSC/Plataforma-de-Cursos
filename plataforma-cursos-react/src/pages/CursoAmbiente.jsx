    ...
    <>
      ...
      <main className="curso-detalhes-page">
        <div className="container">
          <h1 className="curso-titulo">Sustentabilidade e Meio Ambientte</h1>
          <p className="curso-descricao">
          Explore práticas sustentáveis e conceitos ambientais importantes para o dia a dia. Um curso voltado à conscientização e ações práticas.
          </p>
